...
Consider independent ${ X _i \sim \text{Ber}(p _i) }$ random variables. As usual we have sum ${ S _N = \sum _{i=1} ^{N} X _i }$ with mean ${ \mu = \sum _{i=1} ^{N} p _i }.$ For ${ \delta \in (0,1) },$ the tail ${ \mathbb{P}(S _N \geq \mu(1+\delta) ) }$ ${ \leq e ^{-\mu} (\frac{e}{(1+\delta)}) ^{\mu(1+\delta)}  }$ ${ = e ^{\delta \mu} (\frac{1}{1+\delta}) ^{(1+\delta) \mu } }$ ${ = \text{exp}[\mu (\delta - (1+\delta) \text{log}(1+\delta) ) ] }$ ${ {\color{red}{\leq}} e ^{-\mu \frac{\delta ^2}{3} } }.$ 

${ {\color{red}{\text{Lemma}}} }$: For ${ \delta \in (0,1) },$ we have ${ \delta - (1+\delta ) \text{log}(1+\delta) }$ ${ \leq - \frac{\delta ^2}{3} .}$   
**Pic**: ![Link](https://lensdump.com/i/BZC1v2)   
