...
(A convex combination of ${ z _1, \ldots, z _m \in \mathbb{R} ^n }$ is an expression of the form ${ \sum _{1} ^{m} \lambda _i z _i }$ where ${ \lambda _i \geq 0, \sum _{1} ^{m} \lambda _i = 1 }$)   
Pf: For the ${ T }$ finite case, that ${ \text{conv}(\lbrace p _1, \ldots, p _m \rbrace) = \lbrace \sum _{1} ^{m} \lambda _i p _i : \text{each } \lambda _i \geq 0, \sum _{1} ^{m} \lambda _i = 1 \rbrace }$ is shown inductively. 
