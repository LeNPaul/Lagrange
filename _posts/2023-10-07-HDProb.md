...
(A convex combination of ${ z _1, \ldots, z _n \in \mathbb{R} ^n }$ is an expression of the form ${ \sum _{1} ^{m} \lambda _i z _i }$ where ${ \lambda _i \geq 0, \sum _{1} ^{n} \lambda _i = 1 }$)   
Pf: 
